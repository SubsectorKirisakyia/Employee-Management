...
@CrossOrigin("*") //Should only be used for testing or override single handedly against global Cross Origin configuration, it's recommended to globally configure CrossOrigin with WebConfig class or inside SecurityConfig class of Spring Security.
@RestController
